...
/** Llave inglesa / engranaje simplificado: ajustes */
...
export const ArchiveIcon = ({ size = 24, className }: IconProps) => (
  <svg {...base(size)} className={className}>
...
/** Cuadrícula de capas: logo / marca */
export const BrandIcon = ({ size = 24, className }: IconProps) => (
