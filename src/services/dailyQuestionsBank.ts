...
const Q_CONVENIENCIA: DailyQuestion[] = [
  q('Q_CI_01', 'Si hoy has cocinado en casa en vez de pedir delivery, ¿cuánto te has ahorrado?', 12, 'Delivery', 'Lunes, Martes, Miércoles, Jueves', 'Noche', 'Cualquiera', 'comodo', 'impulsivo', 3, 9, 2, 48, 576, 'Evitar 1 pedido semanal ahorra ~48 €/mes'),
  q('Q_CI_02', 'Si hoy te has preparado el café en casa en vez de comprarlo fuera, ¿cuánto te has ahorrado?', 3, 'Cafés', 'Lunes a Viernes', 'Mañana', 'Cualquiera', 'comodo', 'desordenado', 2, 7, 2, 45, 540, 'Café en casa cada día laborable ahorra ~45 €/mes'),
  ...
  q('Q_CI_05', 'Si esta noche has cenado algo sencillo de casa en vez de pedir comida, ¿cuánto te has ahorrado?', 10, 'Delivery', 'Viernes, Sábado', 'Noche', 'Cualquiera', 'comodo', 'social', 3, 8, 3, 40, 480, 'Evitar delivery de fin de semana ahorra ~40 €/mes'),
  q('Q_CI_06', 'Si hoy has revisado la nevera antes de abrir la app de delivery, ¿cuánto te has ahorrado?', 12, 'Delivery', 'Cualquier día', 'Noche', 'Cualquiera', 'comodo', 'impulsivo', 3, 8, 3, 36, 432, 'Revisar nevera antes de pedir evita ~3 pedidos/mes'),
  q('Q_CI_07', 'Si hoy has desayunado en casa en vez de comprar algo por el camino, ¿cuánto te has ahorrado?', 4, 'Cafés', 'Lunes a Viernes', 'Mañana', 'Cualquiera', 'comodo', 'desordenado', 2, 6, 3, 60, 720, 'Desayunar en casa ahorra ~60 €/mes'),
  q('Q_CI_08', 'Si hoy has elegido menú del día en vez de pedir a la carta, ¿cuánto te has ahorrado?', 5, 'Comida', 'Lunes a Viernes', 'Tarde', 'Cualquiera', 'comodo', '', 1, 5, 4, 20, 240, 'Elegir menú del día ahorra ~5 € por comida'),
  q('Q_CI_09', 'Si hoy has hecho la compra en persona en vez de pedirla online con recargo, ¿cuánto te has ahorrado?', 5, 'Compras', 'Sábado, Domingo', 'Mañana', 'Cualquiera', 'comodo', '', 2, 6, 7, 20, 240, 'Compra presencial ahorra el recargo de envío'),
  q('Q_CI_10', 'Si hoy has elegido la opción estándar en vez de la premium (envío, servicio…), ¿cuánto te has ahorrado?', 5, 'Servicios', 'Cualquier día', 'Tarde', 'Cualquiera', 'comodo', 'impulsivo', 2, 6, 4, 15, 180, 'Evitar upgrades innecesarios ahorra ~15 €/mes'),
  q('Q_CI_11', 'Si hoy has caminado un trayecto corto en vez de pedir un VTC, ¿cuánto te has ahorrado?', 6, 'Transporte', 'Cualquier día', 'Tarde', 'Cualquiera', 'comodo', '', 2, 6, 4, 24, 288, 'Caminar trayectos cortos ahorra ~24 €/mes'),
  q('Q_CI_12', 'Si hoy has llevado tu propia botella de agua en vez de comprar, ¿cuánto te has ahorrado?', 2, 'Bebidas', 'Lunes a Viernes', 'Mañana', 'Cualquiera', 'comodo', 'desordenado', 1, 4, 5, 30, 360, 'Llevar botella propia ahorra ~30 €/mes'),
  ...
  q('Q_CI_14', 'Si hoy has preparado snacks de casa en vez de comprar en la tienda o máquina, ¿cuánto te has ahorrado?', 3, 'Snacks', 'Lunes a Viernes', 'Mañana', 'Cualquiera', 'comodo', 'desordenado', 1, 5, 4, 36, 432, 'Snacks de casa en vez de máquina ahorra ~36 €/mes'),
  q('Q_CI_15', 'Si hoy has usado un servicio gratuito en vez de pagar la versión rápida/premium, ¿cuánto?', 4, 'Servicios', 'Cualquier día', 'Tarde', 'Cualquiera', 'comodo', 'impulsivo', 2, 5, 5, 12, 144, 'Usar opciones gratuitas ahorra ~12 €/mes'),
];
...
const Q_IMPROVISADOR: DailyQuestion[] = [
  ...
  q('Q_IM_03', 'Si hoy has preparado comida para aprovechar sobras en vez de comprar nuevo, ¿cuánto te has ahorrado?', 6, 'Sobras', 'Cualquier día', 'Noche', 'Cualquiera', 'comodo', 'desordenado', 2, 7, 3, 24, 288, 'Usar sobras evita ~6 compras innecesarias/mes'),
  q('Q_IM_04', 'Si hoy has hecho la compra con lista y no te has desviado, ¿cuánto te has ahorrado?', 10, 'Compras', 'Sábado, Domingo', 'Mañana', 'Cualquiera', 'comodo', 'desordenado', 2, 7, 7, 40, 480, 'Comprar con lista evita ~40 € en extras/mes'),
  q('Q_IM_05', 'Si esta noche has dejado algo preparado para mañana (comida, café, ropa), ¿cuánto evitarás gastar?', 5, 'Planificación', 'Domingo, Lunes, Martes, Miércoles, Jueves', 'Noche', 'Cualquiera', 'comodo', '', 2, 7, 3, 20, 240, 'Preparar la noche anterior evita gastos por prisa'),
  q('Q_IM_06', 'Si hoy has buscado ruta en transporte público en vez de improvisar con taxi, ¿cuánto te has ahorrado?', 7, 'Transporte', 'Lunes a Viernes', 'Mañana', 'Cualquiera', 'comodo', '', 2, 6, 4, 28, 336, 'Planificar transporte evita taxis de última hora'),
  ...
  q('Q_IM_08', 'Si hoy, al pensar "me pido algo", has parado y cocinado algo rápido, ¿cuánto te has ahorrado?', 10, 'Delivery', 'Cualquier día', 'Noche', 'Cualquiera', 'comodo', 'impulsivo', 3, 8, 3, 30, 360, 'Parar y cocinar evita pedidos impulsivos'),
  q('Q_IM_09', 'Si hoy has traído café/snack de casa en vez de improvisar comprando, ¿cuánto te has ahorrado?', 4, 'Cafés', 'Lunes a Viernes', 'Mañana', 'Cualquiera', 'comodo', '', 2, 6, 3, 48, 576, 'Llevar café y snack de casa ahorra ~48 €/mes'),
  q('Q_IM_10', 'Si hoy has evitado una compra de "emergencia" en tienda de barrio (más cara), ¿cuánto te has ahorrado?', 4, 'Compras', 'Cualquier día', 'Tarde', 'Cualquiera', 'comodo', 'desordenado', 2, 6, 4, 16, 192, 'Evitar compras de emergencia ahorra ~16 €/mes'),
  q('Q_IM_11', 'Si hoy has tenido un plan para la tarde/noche y no has acabado gastando por aburrimiento, ¿cuánto?', 8, 'Ocio', 'Viernes', 'Tarde', 'Cualquiera', 'comodo', 'social', 2, 7, 4, 32, 384, 'Tener plan evita gastos por improvisación'),
  q('Q_IM_12', 'Si hoy has cocinado de más para tener comida mañana, ¿cuánto te ahorrarás?', 8, 'Planificación', 'Domingo, Martes, Miércoles', 'Noche', 'Cualquiera', 'comodo', '', 2, 7, 4, 32, 384, 'Cocinar de más evita comprar al día siguiente'),
  ...
  q('Q_IM_15', 'Si hoy has puesto una alarma/recordatorio para no improvisar la comida de mañana, ¿cuánto evitarás?', 8, 'Planificación', 'Lunes, Martes, Miércoles, Jueves', 'Noche', 'Cualquiera', 'comodo', '', 2, 6, 4, 32, 384, 'Recordatorios nocturnos eliminan improvisación matutina'),
];
...
const Q_FOMO: DailyQuestion[] = [
  q('Q_FS_01', 'Si hoy te han propuesto un plan caro y has dicho que no o propuesto algo más barato, ¿cuánto te has ahorrado?', 15, 'Planes sociales', 'Jueves, Viernes, Sábado', 'Tarde', 'Cualquiera', 'social', 'impulsivo', 3, 9, 3, 60, 720, 'Decir no a 1 plan caro al mes ahorra ~60 €'),
  q('Q_FS_02', 'Si hoy has cenado en casa antes de salir con amigos para gastar menos fuera, ¿cuánto te has ahorrado?', 12, 'Planes sociales', 'Viernes, Sábado', 'Tarde', 'Cualquiera', 'social', 'comodo', 3, 9, 3, 48, 576, 'Cenar antes de salir ahorra ~12 € por noche'),
  ...
  q('Q_FS_04', 'Si hoy has salido con un presupuesto máximo y lo has respetado, ¿cuánto te has ahorrado vs lo que hubieras gastado?', 10, 'Control social', 'Viernes, Sábado', 'Tarde', 'Cualquiera', 'social', 'desordenado', 3, 8, 3, 40, 480, 'Salir con presupuesto ahorra ~40 €/mes'),
  ...
  q('Q_FS_07', 'Es lunes. Si el finde has controlado el gasto social, ¿cuánto menos has gastado de lo que sueles?', 15, 'Reflexión', 'Lunes', 'Mañana', 'Cualquiera', 'social', '', 2, 7, 7, 30, 360, 'Reflexionar el lunes refuerza el control'),
  q('Q_FS_08', 'Si hoy has salido solo con efectivo limitado para controlar gasto, ¿cuánto te has ahorrado?', 10, 'Control social', 'Viernes, Sábado', 'Tarde', 'Cualquiera', 'social', '', 2, 7, 4, 40, 480, 'Salir con cash limita naturalmente el gasto'),
  q('Q_FS_09', 'Si hoy has propuesto hacer plan en casa (series, cena, juegos) en vez de salir, ¿cuánto te has ahorrado?', 15, 'Planes sociales', 'Viernes, Sábado', 'Tarde', 'Cualquiera', 'social', 'comodo', 2, 7, 4, 45, 540, 'Ver algo en casa con amigos vs bar ahorra ~15 €'),
  q('Q_FS_10', 'Si acabas de cobrar y has evitado un plan social caro para no caer en la euforia del cobro, ¿cuánto?', 20, 'Post-cobro', 'Cualquier día', 'Tarde', 'Inicio', 'social', 'impulsivo', 3, 8, 7, 30, 360, 'Controlar post-cobro evita excesos'),
  q('Q_FS_11', 'Si hoy has elegido un sitio más barato para salir con amigos, ¿cuánto te has ahorrado?', 8, 'Planes sociales', 'Viernes, Sábado', 'Noche', 'Cualquiera', 'social', '', 2, 7, 3, 32, 384, 'Elegir sitios más baratos ahorra ~32 €/mes'),
  ...
  q('Q_FS_13', 'Si hoy has disfrutado de un plan solo/a o tranquilo en vez de ir a todo lo que te proponen, ¿cuánto?', 15, 'FOMO', 'Cualquier día', 'Tarde', 'Cualquiera', 'social', '', 2, 7, 5, 30, 360, 'Disfrutar de planes tranquilos reduce gasto social'),
  q('Q_FS_14', 'Si hoy es domingo y estás revisando lo que has gastado este finde en social, ¿cuánto has ahorrado vs otros findes?', 10, 'Reflexión', 'Domingo', 'Mañana', 'Cualquiera', 'social', 'desordenado', 2, 6, 7, 25, 300, 'Revisar gasto social cada semana da perspectiva'),
  q('Q_FS_15', 'Si esta semana has quedado con amigos para hacer algo gratis (deporte, paseo, casa), ¿cuánto te has ahorrado?', 12, 'Ocio gratis', 'Sábado, Domingo', 'Mañana', 'Cualquiera', 'social', '', 2, 7, 7, 36, 432, 'Alternar planes gratis reduce el gasto mensual'),
];
...
const Q_PLAN_ALARGA: DailyQuestion[] = [
  ...
  q('Q_PA_03', 'Si anoche cambiaste a agua o refresco a mitad de noche, ¿cuánto te has ahorrado?', 8, 'Bebidas', 'Sábado, Domingo', 'Mañana', 'Cualquiera', 'social', '', 2, 7, 3, 32, 384, 'Alternar con agua ahorra ~8 € por noche'),
  ...
  q('Q_PA_05', 'Si hoy antes de salir te has puesto un tope de gasto para esta noche, ¿cuánto crees que ahorrarás?', 10, 'Control previo', 'Viernes, Sábado', 'Tarde', 'Cualquiera', 'social', 'desordenado', 3, 8, 3, 40, 480, 'Ponerse un tope antes de salir funciona'),
  q('Q_PA_06', 'Si anoche evitaste invitar una ronda, ¿cuánto te has ahorrado?', 15, 'Rondas', 'Sábado, Domingo', 'Mañana', 'Cualquiera', 'social', '', 2, 7, 4, 30, 360, 'No invitar rondas por presión social ahorra mucho'),
  q('Q_PA_07', 'Es lunes. Si el fin de semana controlaste los planes que se alargan, ¿cuánto menos gastaste?', 15, 'Reflexión', 'Lunes', 'Mañana', 'Cualquiera', 'social', '', 2, 7, 7, 30, 360, 'Lunes de reflexión refuerza el control nocturno'),
  q('Q_PA_08', 'Si anoche elegiste volver andando o en bus en vez de coger taxi de madrugada, ¿cuánto te has ahorrado?', 10, 'Transporte nocturno', 'Sábado, Domingo', 'Mañana', 'Cualquiera', 'social', 'comodo', 2, 7, 3, 40, 480, 'Evitar taxi de madrugada ahorra ~10 € por noche'),
  ...
  q('Q_PA_10', 'Si hoy has tomado algo antes de salir (pre-cena, hidratarte) para gastar menos fuera, ¿cuánto ahorrarás?', 8, 'Control previo', 'Viernes, Sábado', 'Tarde', 'Cualquiera', 'social', 'comodo', 2, 7, 3, 32, 384, 'Precena en casa reduce gasto en restaurante'),
  q('Q_PA_11', 'Si hoy has propuesto el plan (sitio, hora) en vez de dejar que otros elijan uno más caro, ¿cuánto?', 10, 'Control social', 'Jueves, Viernes', 'Tarde', 'Cualquiera', 'social', '', 2, 7, 4, 30, 360, 'Proponer tú el plan te da control del gasto'),
  ...
  q('Q_PA_13', 'Si anoche compartiste platos/tapas en vez de pedir cada uno por separado, ¿cuánto te has ahorrado?', 6, 'Comida social', 'Viernes, Sábado', 'Noche', 'Cualquiera', 'social', '', 1, 5, 4, 18, 216, 'Compartir platos reduce la cuenta un 30%'),
...
const Q_ANTOJO: DailyQuestion[] = [
  q('Q_AE_01', 'Si hoy has cerrado una app de compras sin comprar nada, ¿cuánto te has ahorrado?', 20, 'Compra online', 'Cualquier día', 'Noche', 'Cualquiera', 'impulsivo', 'comodo', 3, 9, 2, 40, 480, 'Cerrar la app sin comprar ahorra ~40 €/mes'),
  ...
  q('Q_AE_05', 'Si hoy has evitado un capricho de comida/bebida (snack, café especial, dulce), ¿cuánto te has ahorrado?', 4, 'Caprichos', 'Cualquier día', 'Tarde', 'Cualquiera', 'impulsivo', 'comodo', 2, 7, 2, 48, 576, 'Los caprichos diarios suman mucho al mes'),
  ...
  q('Q_AE_07', 'Si hoy has resistido una notificación de oferta/promoción sin entrar a comprar, ¿cuánto?', 15, 'Notificaciones', 'Cualquier día', 'Tarde', 'Cualquiera', 'impulsivo', '', 2, 7, 3, 30, 360, 'Ignorar notificaciones de ofertas evita compras innecesarias'),
  ...
  q('Q_AE_09', 'Si hoy has elegido entretenimiento gratuito (leer, pasear, peli en casa) en vez de gastar, ¿cuánto?', 10, 'Ocio', 'Cualquier día', 'Noche', 'Cualquiera', 'impulsivo', '', 2, 6, 4, 20, 240, 'Entretenimiento gratis vs de pago ahorra ~20 €/mes'),
  q('Q_AE_10', 'Si hoy has eliminado un artículo del carrito antes de finalizar la compra, ¿cuánto te has ahorrado?', 15, 'Compra online', 'Cualquier día', 'Noche', 'Cualquiera', 'impulsivo', '', 2, 7, 3, 30, 360, 'Revisar el carrito antes de pagar reduce el gasto'),
  q('Q_AE_11', 'Si hoy sentías un antojo de algo y lo has sustituido por una alternativa gratis, ¿cuánto?', 5, 'Caprichos', 'Cualquier día', 'Tarde', 'Cualquiera', 'impulsivo', 'comodo', 2, 7, 3, 20, 240, 'Sustituir antojos por alternativas gratis funciona'),
  q('Q_AE_12', 'Si hoy te has dado un "autocuidado gratis" (baño, música, paseo) en vez de comprar algo, ¿cuánto?', 10, 'Emocional', 'Sábado, Domingo', 'Tarde', 'Cualquiera', 'impulsivo', '', 2, 6, 5, 20, 240, 'Autocuidado gratis sustituye a comprarse caprichos'),
  ...
  q('Q_AE_14', 'Si hoy has evitado añadir extras al finalizar una compra (el típico "¿quieres añadir…?"), ¿cuánto?', 5, 'Extras', 'Cualquier día', 'Tarde', 'Cualquiera', 'impulsivo', 'comodo', 2, 6, 3, 15, 180, 'Los extras al comprar suman ~15 €/mes'),
  q('Q_AE_15', 'Domingo de reflexión: ¿cuánto has evitado gastar en impulsos esta semana?', 15, 'Reflexión', 'Domingo', 'Mañana', 'Cualquiera', 'impulsivo', '', 2, 7, 7, 30, 360, 'Reflexionar el domingo refuerza el autocontrol'),
];
...
const Q_CAZADOR: DailyQuestion[] = [
  ...
  q('Q_CO_03', 'Si hoy has visto un 2x1 y has pasado de él porque no lo necesitabas, ¿cuánto te has ahorrado?', 8, 'Ofertas', 'Cualquier día', 'Tarde', 'Cualquiera', 'impulsivo', '', 2, 7, 3, 24, 288, 'Los 2x1 que no necesitas cuestan el doble de nada'),
  ...
  q('Q_CO_06', 'Si hoy te has desuscrito de alguna newsletter de ofertas/tienda, ¿cuánto evitarás gastar al mes?', 10, 'Marketing', 'Lunes', 'Mañana', 'Cualquiera', 'impulsivo', '', 2, 7, 14, 20, 240, 'Menos newsletters = menos tentaciones'),
  q('Q_CO_07', 'Si hoy has ido a la compra solo con lista y no has comprado cosas en oferta que no necesitabas, ¿cuánto?', 10, 'Compras', 'Sábado', 'Mañana', 'Cualquiera', 'impulsivo', 'comodo', 3, 8, 7, 40, 480, 'Solo con lista = sin extras innecesarios en oferta'),
  ...
  q('Q_CO_09', 'Si hoy has evitado comprar un "añadido" tentador en caja (chicles, gadgets, ofertas), ¿cuánto?', 4, 'Extras', 'Cualquier día', 'Tarde', 'Cualquiera', 'impulsivo', 'desordenado', 1, 5, 3, 12, 144, 'Los extras de caja suman ~12 €/mes sin que te des cuenta'),
  q('Q_CO_10', 'Si hoy has evitado entrar en webs de ofertas diarias (Groupon, outlets, deals), ¿cuánto?', 15, 'Compra online', 'Martes, Miércoles', 'Noche', 'Cualquiera', 'impulsivo', '', 2, 7, 4, 30, 360, 'No visitar webs de ofertas elimina la compra innecesaria'),
  q('Q_CO_11', 'Si hoy has dicho no a un "regalo por compra mínima" que te hubiese hecho gastar de más, ¿cuánto?', 10, 'Marketing', 'Cualquier día', 'Tarde', 'Cualquiera', 'impulsivo', '', 2, 7, 5, 20, 240, 'Gastar más para el regalo no es ahorrar'),
  q('Q_CO_12', 'Si a principios de mes has fijado un tope para "ofertas" y hoy lo has respetado, ¿cuánto has ahorrado?', 20, 'Control', 'Cualquier día', 'Mañana', 'Inicio', 'impulsivo', 'desordenado', 3, 8, 7, 40, 480, 'Tope mensual de ofertas controla la hemorragia'),
  q('Q_CO_13', 'Si hoy has calculado el descuento real (no el % inflado) y has decidido que no valía la pena, ¿cuánto?', 12, 'Ofertas', 'Cualquier día', 'Tarde', 'Cualquiera', 'impulsivo', '', 2, 7, 4, 24, 288, 'Calcular el descuento real destapa el humo del marketing'),
  q('Q_CO_14', 'Domingo de revisión: ¿cuánto has evitado gastar en ofertas/rebajas esta semana?', 15, 'Reflexión', 'Domingo', 'Mañana', 'Cualquiera', 'impulsivo', '', 2, 7, 7, 30, 360, 'Reflexionar cada semana sobre ofertas da perspectiva'),
  q('Q_CO_15', 'Si hoy has preguntado "¿dónde voy a guardar esto?" antes de comprar algo en oferta y no lo has comprado, ¿cuánto?', 15, 'Ofertas', 'Cualquier día', 'Noche', 'Cualquiera', 'impulsivo', '', 2, 7, 4, 30, 360, 'Si no tienes dónde ponerlo, no lo necesitas'),
];
...
const Q_MICROFUGAS: DailyQuestion[] = [
  q('Q_MF_01', 'Si hoy te has preparado el café en casa en vez de comprarlo, ¿cuánto te has ahorrado?', 2, 'Cafés', 'Lunes a Viernes', 'Mañana', 'Cualquiera', 'desordenado', 'comodo', 2, 8, 2, 40, 480, 'El café diario fuera cuesta ~40 €/mes'),
  q('Q_MF_02', 'Si hoy has traído comida/snacks de casa en vez de comprar algo suelto, ¿cuánto te has ahorrado?', 4, 'Snacks', 'Lunes a Viernes', 'Mañana', 'Cualquiera', 'desordenado', 'comodo', 2, 7, 2, 48, 576, 'Snacks sueltos cuestan ~48 €/mes'),
  ...
  q('Q_MF_05', 'Si hoy has usado tu propia botella de agua en vez de comprar, ¿cuánto te has ahorrado?', 1, 'Bebidas', 'Cualquier día', 'Mañana', 'Cualquiera', 'desordenado', '', 1, 5, 3, 20, 240, 'Comprar agua embotellada suma ~20 €/mes'),
  q('Q_MF_06', 'Si hoy has pasado por una tienda sin entrar "a mirar" y acabar comprando algo, ¿cuánto te has ahorrado?', 8, 'Compras casuales', 'Cualquier día', 'Tarde', 'Cualquiera', 'desordenado', 'impulsivo', 2, 7, 3, 24, 288, 'Entrar "solo a mirar" casi nunca es gratis'),
  q('Q_MF_07', 'Si hoy has usado la versión gratuita de algo en vez de pagar premium, ¿cuánto te has ahorrado?', 5, 'Apps/Servicios', 'Cualquier día', 'Tarde', 'Cualquiera', 'desordenado', 'comodo', 2, 6, 5, 10, 120, 'Las versiones gratuitas a menudo son suficientes'),
  q('Q_MF_08', 'Si hoy has comprado a granel o formato grande en vez de packs individuales, ¿cuánto te has ahorrado?', 3, 'Compras', 'Sábado', 'Mañana', 'Cualquiera', 'desordenado', '', 2, 6, 7, 12, 144, 'Comprar a granel ahorra ~12 €/mes vs individual'),
  q('Q_MF_09', 'Si hoy has evitado comprar algo innecesario en el súper de barrio (más caro), ¿cuánto te has ahorrado?', 3, 'Compras', 'Lunes a Viernes', 'Tarde', 'Cualquiera', 'desordenado', 'comodo', 2, 6, 3, 18, 216, 'El súper de barrio tiene un 20% de sobrecoste'),
  ...
  q('Q_MF_11', 'Si hoy has evitado un refresco/zumo/bebida de máquina y has bebido agua, ¿cuánto te has ahorrado?', 2, 'Bebidas', 'Lunes a Viernes', 'Tarde', 'Cualquiera', 'desordenado', '', 1, 5, 2, 24, 288, 'Refrescos diarios cuestan ~24 €/mes'),
  q('Q_MF_12', 'Si hoy has compartido cuenta de streaming/servicio con alguien, ¿cuánto te ahorras al mes?', 5, 'Suscripciones', 'Cualquier día', 'Noche', 'Cualquiera', 'desordenado', '', 2, 6, 14, 8, 96, 'Compartir cuentas reduce suscripciones a la mitad'),
  q('Q_MF_13', 'Si hoy has traído tu propia bolsa a la compra y evitado pagar por bolsas, ¿cuánto te has ahorrado?', 1, 'Compras', 'Sábado, Domingo', 'Mañana', 'Cualquiera', 'desordenado', '', 1, 3, 7, 3, 36, 'Cada bolsa son céntimos que suman al año'),
  q('Q_MF_14', 'Domingo de revisión: ¿cuánto suman tus gastos pequeños de esta semana que podrías haber evitado?', 10, 'Reflexión', 'Domingo', 'Mañana', 'Cualquiera', 'desordenado', '', 2, 7, 7, 20, 240, 'Las microfugas semanales suman ~20 €'),
...
const Q_SIN_SISTEMA: DailyQuestion[] = [
  ...
  q('Q_SS_05', 'Si hoy has categorizado tus gastos de ayer (comida, transporte, ocio…), ¿cuánto podrías haber evitado?', 5, 'Control', 'Cualquier día', 'Mañana', 'Cualquiera', 'desordenado', '', 2, 7, 3, 15, 180, 'Categorizar gastos revela dónde se va el dinero'),
  ...
  q('Q_SS_07', 'Si hoy has evitado un gasto que normalmente harías sin pensar, ¿cuánto te has ahorrado?', 8, 'Conciencia', 'Cualquier día', 'Tarde', 'Cualquiera', 'desordenado', 'impulsivo', 2, 7, 3, 24, 288, 'Parar y pensar antes de gastar marca la diferencia'),
  ...
  q('Q_SS_11', 'Si hoy has detectado un pago recurrente que puedes reducir (tarifa, seguro, plan), ¿cuánto al mes?', 10, 'Suscripciones', 'Cualquier día', 'Mañana', 'Final', 'desordenado', '', 3, 8, 14, 15, 180, 'Las tarifas se pueden negociar casi siempre'),
  q('Q_SS_12', 'Si hoy, al ver tu saldo, has decidido NO hacer un gasto que ibas a hacer, ¿cuánto te has ahorrado?', 10, 'Control', 'Cualquier día', 'Tarde', 'Cualquiera', 'desordenado', '', 2, 7, 3, 20, 240, 'La visibilidad del saldo frena el gasto automático'),
  q('Q_SS_13', 'Si hoy has encontrado un gasto mensual que puedes reducir o eliminar, ¿cuánto te ahorras al mes?', 8, 'Optimización', 'Cualquier día', 'Mañana', 'Cualquiera', 'desordenado', '', 2, 7, 7, 12, 144, 'Optimizar gastos fijos reduce el coste de vida'),
  q('Q_SS_14', 'Si hoy has puesto una alarma semanal para revisar tus finanzas, ¿cuánto crees que ahorrarás?', 10, 'Hábito', 'Domingo', 'Mañana', 'Cualquiera', 'desordenado', '', 2, 7, 14, 20, 240, 'La disciplina de revisar cada semana genera el hábito'),
  q('Q_SS_15', 'Si hoy has identificado tus 3 gastos más grandes del mes, ¿cuánto podrías reducir de cada uno?', 15, 'Reflexión', 'Cualquier día', 'Mañana', 'Final', 'desordenado', '', 3, 8, 30, 30, 360, 'Conocer tus top 3 gastos es el primer paso'),
];
...
const Q_FILL_BLANK: DailyQuestion[] = [
  // ── Cómodo / Conveniencia ──────────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'un capricho impulsivo',           value: 'capricho', scores: { impulsivo: 2 } },
    ],
    allowOther: true,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'la compra con lista en vez de improvisar', value: 'compra_lista', scores: { desordenado: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  // ── Social / FOMO ──────────────────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'una compra impulsiva con el grupo',  value: 'compra_grupo', scores: { impulsivo: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'taxis y desplazamientos nocturnos',  value: 'taxi_noche',  scores: { comodo: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  // ── Impulsivo / Antojo ──────────────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'algo que me recomendó alguien',    value: 'recomendado', scores: { social: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'decoración u objetos para casa', value: 'deco',       scores: { comodo: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  // ── Desordenado / Microfugas ──────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'un snack o bebida del trabajo',         value: 'snack',      scores: { comodo: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'compras por impulso que no recuerdo',    value: 'impulso_olvidado', scores: { impulsivo: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  // ── Cómodo / Delivery ──────────────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'he planificado la cena con antelación',  value: 'planif',   scores: { desordenado: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  // ── Impulsivo / Suscripciones y ofertas ───────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'una tarifa que podía reducir',         value: 'tarifa',      scores: { desordenado: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  // ── Social / Presión de grupo ──────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'renunciar al plan y quedarme sin gastar',   value: 'no_plan',     scores: { impulsivo: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  // ── Desordenado / Sin sistema ──────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'ceder a un antojo en el último momento',  value: 'antojo',    scores: { impulsivo: 2 } },
    ],
    allowOther: true,
    otherRequiresAI: true,
    aiConfidenceThreshold: 0.70,
  ...
  // ── Cómodo / Conveniencia (cont.) ───────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'he planificado la ruta para evitar tentaciones', value: 'ruta_plan', scores: { desordenado: 2 } },
    ],
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'coordinarme con alguien para ir juntos',     value: 'compartir_v',   scores: { social: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'revisando lo que ya tenía antes de ir',        value: 'revisar_prev', scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he hecho batch cooking el finde para toda la semana', value: 'batch',  scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he resistido el capricho de comprar algo para entretenerme', value: 'cap_entret', scores: { impulsivo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he planificado la compra en vez de comprar sobre la marcha', value: 'planif_compra', scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he hecho el plan semanal para no improvisar gastos', value: 'plan_semanal', scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he comparado opciones antes de entrar al primer sitio', value: 'comparar_antes', scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  // ── Social / FOMO (cont.) ───────────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'cocinar juntos en vez de ir a restaurante',      value: 'cocinar_juntos', scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he decidido el tope de gasto antes de llegar y lo he cumplido', value: 'tope_previo', scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he resistido la presión del grupo y salido ganando',  value: 'resistir_grupo', scores: { impulsivo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he salido antes para coger el último metro',       value: 'salir_antes',  scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he decidido de antemano el tope de gasto del día', value: 'tope_dia',    scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he marcado un máximo de consumiciones y lo he cumplido', value: 'max_consumiciones', scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'no comprar lo que todos compraban solo por no quedar mal', value: 'no_presion_compra', scores: { impulsivo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he rechazado el último local más caro al que iban',    value: 'no_local_caro', scores: { impulsivo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'una tarde de juegos o películas en casa',         value: 'juegos_casa', scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  // ── Impulsivo / Antojo (cont.) ───────────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'artículos de hogar o decoración que me gustaron',    value: 'carrito_deco',  scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'porque me he dado cuenta de que ya tenía algo similar', value: 'ya_tenia_similar', scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'un plan o experiencia que parecía imprescindible', value: 'exp_social',     scores: { social: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'cuando vi algo bonito sin tener ninguna necesidad', value: 'compra_capricho', scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he cancelado las notificaciones de ofertas',          value: 'cancelar_noti', scores: { desordenado: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'algo que vi en feria, mercadillo o tienda pop-up',  value: 'espera_feria', scores: { social: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'algo de hogar o decoración en rebajas',               value: 'oferta_hogar', scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  // ── Desordenado / Microfugas (cont.) ─────────────────────────────────────
  {
    ...
    blankOptions: [
      ...
      { label: 'de entrega periódica física que había olvidado',      value: 'cancel_fisico',   scores: { impulsivo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'una tarifa que podía reducir llamando al proveedor',    value: 'tarifa_red',  scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he preparado ropa y material para no comprar de urgencia', value: 'prep_urgencia', scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
    suggestedAmount: 20, habitCategory: 'Planificación semanal', bestDays: 'Domingo', bestTimeWindow: 'Mañana',
    monthPhase: 'Cualquiera', targetAvatarPrimary: 'desordenado', targetAvatarSecondary: 'comodo',
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'en compras de impulso que podría haber evitado',        value: 'impulso_rev',  scores: { impulsivo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he marcado un límite para una categoría en la que me pasaba',   value: 'limite_cat', scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'había preparado alternativa por si el plan fallaba',            value: 'plan_b',      scores: { comodo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'he evitado el pasillo de ofertas y productos capricho',  value: 'evitar_pasillo', scores: { impulsivo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
  ...
  },
  {
    ...
    blankOptions: [
      ...
      { label: 'gastos de ropa y caprichos personales',        value: 'ropa_margen',  scores: { impulsivo: 2 } },
    ],
    allowOther: true, otherRequiresAI: true, aiConfidenceThreshold: 0.70,
